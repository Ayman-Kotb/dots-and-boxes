...
void check_adjacent_load(char MODE_B_E, unsigned char array_of_grid_of_beginners[9][17], unsigned char array_of_grid_of_experts[21][41], int row_mid, int column_mid, int turn_player, int *x, int *y , int* score1 , int* score2 )
{
    int directional_array_adj[2][4] = {0, 0, -2, 2,
                                       -4, 4, 0, 0};
    int row_d, column_d;
    ...
    if (MODE_B_E == '2')
    {
        ...
        if (number_of_lines_adj == 3)
        {
            ...
            else if ((turn_player == 2) || (turn_player ==0)) 
            {
                (*score2)++;
            }
            ...
            (*y)--;
            array_of_grid_of_beginners[row_mid][column_mid] = (turn_player + '0');
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_mid + 4, column_mid, turn_player, x, y , score1 ,score2 );
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_mid - 4, column_mid, turn_player, x, y , score1 ,score2 );
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_mid, column_mid + 8, turn_player, x, y , score1 ,score2 );
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_mid, column_mid - 8, turn_player, x, y , score1 ,score2 );
        }
        else if ((number_of_lines_adj == 4) && (array_of_grid_of_beginners[row_mid][column_mid] == ' '))
        {
