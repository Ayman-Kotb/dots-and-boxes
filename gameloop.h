      ...
      if (turn % 2 == 0 && (*ln_l) > 0)
      {
        ...
        if (letter_be_changed > 96)
        {
          ...
          if (right_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e - 4, 1, ln_l, bx_l, score1_l ,score2_l);     // check left
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e + 12, 1, ln_l, bx_l, score1_l ,score2_l);    // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 4, col_e + 4, 1, ln_l, bx_l, score1_l ,score2_l); // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 4, col_e + 4, 1, ln_l, bx_l, score1_l ,score2_l); // lower
          }
          else
          {
            ...
            if (left_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e + 4, 1, ln_l, bx_l, score1_l ,score2_l );     // check right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e - 12, 1, ln_l, bx_l, score1_l ,score2_l);    // left
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 4, col_e - 4, 1, ln_l, bx_l, score1_l ,score2_l); // upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 4, col_e - 4, 1, ln_l, bx_l, score1_l ,score2_l); // lower
            }
          }
        ...
        else
        {
          ...
          if (lower_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 6, col_e, 1, ln_l, bx_l, score1_l ,score2_l);     //  check lower
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e, 1, ln_l, bx_l, score1_l ,score2_l);     // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e + 8, 1, ln_l, bx_l, score1_l ,score2_l); // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e - 8, 1, ln_l, bx_l, score1_l ,score2_l); // left
          }
          else
          {
            ...
            if (upper_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e, 1, ln_l, bx_l, score1_l ,score2_l);     //  lower
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 6, col_e, 1, ln_l, bx_l, score1_l ,score2_l);     //  upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e + 8, 1, ln_l, bx_l, score1_l ,score2_l); // right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e - 8, 1, ln_l, bx_l, score1_l ,score2_l); // left
            }
          }
      ...
      else if (turn % 2 == 1 && (*ln_l) >= 0)
      {
        ...
        if (letter_be_changed > 96)
        {
          ...
          if (right_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e - 4, 2, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e + 12, 2, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 4, col_e + 4, 2, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 4, col_e + 4, 2, ln_l, bx_l, score1_l ,score2_l);
          }
          else
          {
            ...
            if (left_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e + 4, 2, ln_l, bx_l, score1_l ,score2_l);     // check right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e - 12, 2, ln_l, bx_l, score1_l ,score2_l);    // left
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 4, col_e - 4, 2, ln_l, bx_l, score1_l ,score2_l); // upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 4, col_e - 4, 2, ln_l, bx_l, score1_l ,score2_l); // lower
            }
          }
        }
        else
        {
          ...
          if (lower_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 6, col_e, 2, ln_l, bx_l, score1_l ,score2_l);     //  check lower
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e, 2, ln_l, bx_l, score1_l ,score2_l);     // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e + 8, 2, ln_l, bx_l, score1_l ,score2_l); // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e - 8, 2, ln_l, bx_l, score1_l ,score2_l); // left
          }
          else
          {
            ...
            if (upper_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e, 2, ln_l, bx_l, score1_l ,score2_l);     //  lower
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 6, col_e, 2, ln_l, bx_l, score1_l ,score2_l);     //  upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e + 8, 2, ln_l, bx_l, score1_l ,score2_l); // right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e - 8, 2, ln_l, bx_l, score1_l ,score2_l); // left}
            }
          }
      ...
      else if (i % 2 == 1 && (*ln_l) >= 0)
      {
        ...
        if (letter_be_changed > 96)
        {
          ...
          if (right_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e - 4, 0, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e + 12, 0, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 4, col_e + 4, 0, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 4, col_e + 4, 0, ln_l, bx_l, score1_l ,score2_l);
          }
          else
          {
            ...
            if (left_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e + 4, 0, ln_l, bx_l, score1_l ,score2_l);     // check right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e, col_e - 12, 0, ln_l, bx_l, score1_l ,score2_l);    // left
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 4, col_e - 4, 0, ln_l, bx_l, score1_l ,score2_l); // upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 4, col_e - 4, 0, ln_l, bx_l, score1_l ,score2_l); // lower
            }
          }
        }
        else
        {
          ...
          if (lower_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 6, col_e, 0, ln_l, bx_l, score1_l ,score2_l);     //  check lower
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e, 0, ln_l, bx_l, score1_l ,score2_l);     // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e + 8, 0, ln_l, bx_l, score1_l ,score2_l); // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e - 8, 0, ln_l, bx_l, score1_l ,score2_l); // left
          }
          else
          {
            ...
            if (upper_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e + 2, col_e, 0, ln_l, bx_l, score1_l ,score2_l);     //  lower
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 6, col_e, 0, ln_l, bx_l, score1_l ,score2_l);     //  upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e + 8, 0, ln_l, bx_l, score1_l ,score2_l); // right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_e - 2, col_e - 8, 0, ln_l, bx_l, score1_l ,score2_l); // left}
            }
          }
      ...
      if (turn % 2 == 0 && (*ln_l) >= 0)
      {
        ...
        if (letter_be_changed > 96)
        {
          ...
          if (right_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b - 4, 1, ln_l, bx_l, score1_l ,score2_l);     // check left
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b + 12, 1, ln_l, bx_l, score1_l ,score2_l);    // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 4, col_b + 4, 1, ln_l, bx_l, score1_l ,score2_l); // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 4, col_b + 4, 1, ln_l, bx_l, score1_l ,score2_l); // lower
          }
          else
          {
            ...
            if (left_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b + 4, 1, ln_l, bx_l, score1_l ,score2_l);     // check right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b - 12, 1, ln_l, bx_l, score1_l ,score2_l);    // left
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 4, col_b - 4, 1, ln_l, bx_l, score1_l ,score2_l); // upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 4, col_b - 4, 1, ln_l, bx_l, score1_l ,score2_l); // lower
            }
          }
        ...
        else
        {
          ...
          if (lower_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 6, col_b, 1, ln_l, bx_l, score1_l ,score2_l);     //  check lower
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b, 1, ln_l, bx_l, score1_l ,score2_l);     // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b + 8, 1, ln_l, bx_l, score1_l ,score2_l); // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b - 8, 1, ln_l, bx_l, score1_l ,score2_l); // left
          }
          else
          {
            ...
            if (upper_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b, 1, ln_l, bx_l, score1_l ,score2_l);     //  lower
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 6, col_b, 1, ln_l, bx_l, score1_l ,score2_l);     //  upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b + 8, 1, ln_l, bx_l, score1_l ,score2_l); // right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b - 8, 1, ln_l, bx_l, score1_l ,score2_l); // left
            }
          }
      ...
      else if (turn % 2 == 1 && (*ln_l) >= 0)
      {
        ...
        if (letter_be_changed > 96)
        {
          ...
          if (right_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b - 4, 2, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b + 12, 2, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 4, col_b + 4, 2, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 4, col_b + 4, 2, ln_l, bx_l, score1_l ,score2_l);
          }
          else
          {
            ...
            if (left_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b + 4, 2, ln_l, bx_l, score1_l ,score2_l);     // check right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b - 12, 2, ln_l, bx_l, score1_l ,score2_l);    // left
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 4, col_b - 4, 2, ln_l, bx_l, score1_l ,score2_l); // upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 4, col_b - 4, 2, ln_l, bx_l, score1_l ,score2_l); // lower
            }
          }
        }
        else
        {
          ...
          if (lower_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 6, col_b, 2, ln_l, bx_l, score1_l ,score2_l);     //  check lower
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b, 2, ln_l, bx_l, score1_l ,score2_l);     // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b + 8, 2, ln_l, bx_l, score1_l ,score2_l); // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b - 8, 2, ln_l, bx_l, score1_l ,score2_l); // left
          }
          else
          {
            ...
            if (upper_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b, 2, ln_l, bx_l, score1_l ,score2_l);     //  lower
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 6, col_b, 2, ln_l, bx_l, score1_l ,score2_l);     //  upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b + 8, 2, ln_l, bx_l, score1_l ,score2_l); // right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b - 8, 2, ln_l, bx_l, score1_l ,score2_l); // left}
            }
          }
      ...
      else if (turn % 2 == 1 && (*ln_l) >= 0)
      {
        ...
        if (letter_be_changed > 96)
        {
          ...
          if (right_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b - 4, 0, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b + 12, 0, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 4, col_b + 4, 0, ln_l, bx_l, score1_l ,score2_l);
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 4, col_b + 4, 0, ln_l, bx_l, score1_l ,score2_l);
          }
          else
          {
            ...
            if (left_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b + 4, 0, ln_l, bx_l, score1_l ,score2_l);     // check right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b, col_b - 12, 0, ln_l, bx_l, score1_l ,score2_l);    // left
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 4, col_b - 4, 0, ln_l, bx_l, score1_l ,score2_l); // upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 4, col_b - 4, 0, ln_l, bx_l, score1_l ,score2_l); // lower
            }
          }
        }
        else
        {
          ...
          if (lower_box == 4)
          {
            ...
            turn++;
            (*bx_l)--;
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 6, col_b, 0, ln_l, bx_l, score1_l ,score2_l);     //  check lower
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b, 0, ln_l, bx_l, score1_l ,score2_l);     // upper
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b + 8, 0, ln_l, bx_l, score1_l ,score2_l); // right
            check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b - 8, 0, ln_l, bx_l, score1_l ,score2_l); // left
          }
          else
          {
            ...
            if (upper_box == 4)
            {
              ...
              turn++;
              (*bx_l)--;
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b + 2, col_b, 0, ln_l, bx_l, score1_l ,score2_l);     //  lower
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 6, col_b, 0, ln_l, bx_l, score1_l ,score2_l);     //  upper
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b + 8, 0, ln_l, bx_l, score1_l ,score2_l); // right
              check_adjacent_load(MODE_B_E, array_of_grid_of_beginners, array_of_grid_of_experts, row_b - 2, col_b - 8, 0, ln_l, bx_l, score1_l ,score2_l); // left}
            }
          }
